...
func (e Ext12) ExptSq(x *E12) *E12 {
	// ExptSq computation is derived from the addition chain:
	//
	//	_10      = 2*1
	//	_11      = 1 + _10
	//	_1100    = _11 << 2
	...
	//	_1101001 = 1 + _1101000
	//	i19      = _1101001 << 9 + 1
	//	i27      = ((2*i19 + i19) << 2 + i19) << 3
	//	i70      = ((i19 + i27) << 9 + i19) << 31 + i19
	//	return     (i70 << 33 + 1) << 32
	//
	// Operations: 126 squares 10 multiplies
	//
...
func (e Ext12) FinalExponentiationCheck(x *E12) *E12 {
	...
	// Check that  x == residueWitness^r
	// where r = u^4 - u^2 + 1, with u the BLS12-381 seed
	// and residueWitness from the hint.
	t0 := e.ExptSq(&residueWitness)
	t1 := e.DivUnchecked(t0, &residueWitness)
	t1 = e.ExptSq(t1)
	t1 = e.Mul(t1, &residueWitness)

	e.AssertIsEqual(x, t1)
